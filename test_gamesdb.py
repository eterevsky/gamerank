...
class TestGamesDB(unittest.TestCase):
    ...
    def test_dates_compatible(self):
        ...
        assertTrue(_dates_compatible(date1, precision1, date1, precision1))
        date2, precision2 = _parse_date('2005-??-??')
        assertTrue(_dates_compatible(date1, precision1, date2, precision2))
        date3, precision3 = _parse_date('2006-??-??')
        assertFalse(_dates_compatible(date3, precision3, date2, precision2))
        date4, precision4 = _parse_date('2005-12-??')
        assertTrue(_dates_compatible(date1, precision1, date4, precision4))
        assertTrue(_dates_compatible(date2, precision2, date4, precision4))
        assertFalse(_dates_compatible(date3, precision3, date4, precision4))
        date5, precision5 = _parse_date('2005-10-??')
        assertFalse(_dates_compatible(date4, precision4, date5, precision5))
        date6, precision6 = _parse_date('2006-10-??')
        assertTrue(_dates_compatible(date3, precision3, date6, precision6))
        assertFalse(_dates_compatible(date5, precision5, date6, precision6))
        date7, precision7 = _parse_date('2005-10-05')
        assertTrue(_dates_compatible(date1, precision1, date7, precision7))
        assertTrue(_dates_compatible(date2, precision2, date7, precision7))
        assertFalse(_dates_compatible(date3, precision3, date7, precision7))
        assertFalse(_dates_compatible(date4, precision4, date7, precision7))
        assertTrue(_dates_compatible(date5, precision5, date7, precision7))
        assertFalse(_dates_compatible(date6, precision6, date7, precision7))
        assertTrue(_dates_compatible(date7, precision7, date7, precision7))
        date7, precision7 = _parse_date('2005-10-04')
        assertFalse(_dates_compatible(date8, precision8, date7, precision7))
